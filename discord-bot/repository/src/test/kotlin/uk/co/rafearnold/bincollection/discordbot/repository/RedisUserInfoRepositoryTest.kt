...
class RedisUserInfoRepositoryTest {
    ...
    fun `user info can be checked for existence`() {
        ...
        val redisKey1 = "uk.co.rafearnold.bin-collection-service.discord-bot.user-info.$userId1"
    ...
    fun `all user info can be retrieved`() {
        ...
        val redisKey1 = "uk.co.rafearnold.bin-collection-service.discord-bot.user-info.$userId1"
        val redisKey2 = "uk.co.rafearnold.bin-collection-service.discord-bot.user-info.$userId2"
        val redisKey3 = "uk.co.rafearnold.bin-collection-service.discord-bot.user-info.$userId3"
        ...
        val expectedResult2: Map<String, StoredUserInfo> =
            mapOf(
                userId1 to StoredUserInfo(
                    ...
                    discordUserDisplayName = "test_discordUserDisplayName1",
                ...
                userId2 to StoredUserInfo(
                    ...
                    discordUserDisplayName = "test_discordUserDisplayName2",
