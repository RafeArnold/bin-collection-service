...
import uk.co.rafearnold.bincollection.fremantle.FremantleApiModule
import uk.co.rafearnold.bincollection.fremantle.FremantleBinCollectionService
import uk.co.rafearnold.bincollection.fremantle.FremantleBinCollectionServiceImpl
...
class InternalApiModule : AbstractModule() {
    ...
    override fun configure() {
        ...
        bind(FremantleBinCollectionService::class.java)
            .to(FremantleBinCollectionServiceImpl::class.java).`in`(Scopes.SINGLETON)
